# python text_classify.py userid classes
# Import Libraries
import boto3
import io
import pandas as pd
...
USERID = sys.argv[1]
CLASSES = sys.argv[2]
S3_FILE_NAME = f'{USERID}/{USERID}_dataset.csv'
FOLDER_NAME = "data_folder"
MODEL_SAVE_PATH = f'{FOLDER_NAME}/saved_weights.pt'
S3_MODEL_SAVE = f'{USERID}/saved_weights.pt'
TOKENIZER_PATH = f'{FOLDER_NAME}/tokenizer.pkl'
S3_TOKENIZER_PATH = f'{USERID}/tokenizer.pkl'
